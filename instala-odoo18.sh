...
LOG_FILE="${LOG_DIR}/instala-odoo18_$(date +%Y%m%d_%H%M%S).log"
...
banner() {
    log ""
    log "${BOLD}${CYAN}╔══════════════════════════════════════════════╗${RESET}"
    log "${BOLD}${CYAN}║    Instalación Odoo 18 – Docker + Portainer  ║${RESET}"
    log "${BOLD}${CYAN}╚══════════════════════════════════════════════╝${RESET}"
    log ""
}
...
run_script() {
    ...
    # Ejecutar y capturar salida; en caso de fallo mostrar error claro
...
show_summary() {
    ...
    log "${BOLD}${GREEN}╚══════════════════════════════════════════════╝${RESET}"
    log ""
    log "  Odoo 18 está instalado y configurado con:"
